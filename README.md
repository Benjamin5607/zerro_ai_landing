...
- **Legal Research** plugin (KR_AI_Legal) — Workspace sidebar ⚖️ Legal
...
https://github.com/Benjamin5607/zerro_ai_landing/releases/download/desktop-v0.2.10/Zerro-Dev-Studio-0.2.10-Setup.zip
```
